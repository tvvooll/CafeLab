...
namespace CafeLab.Controllers
{
    public class DishesController : Controller
    {
        ...
        public DishesController(DBCafeContext context)
        {
            _context = context;
        }
        ...
        {
            if (id is null)
                return View(await _context.Dishes.Include(c => c.Category).ToListAsync());
            ViewBag.CategoryId = id;
            ViewBag.CategoryName = name;
            var dishesByCategory = _context.Dishes.Where(b => b.CategoryId == id)
                                                  .Include(b => b.Category);

            return View(await dishesByCategory.ToListAsync());
        }
